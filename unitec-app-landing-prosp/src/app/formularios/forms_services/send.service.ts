...
if (isMobile) {
  ...
  jQuery(".img-header-thankyou").css({
    ...
    if (
       ...
       *
       *
       * Termina obtención de datos Solvis
       *
       *
       *
       *
     ...
     var TelefonoPredictivo2 = '901'+jQuery("#formApp").data("celular").substring(2,jQuery("#formApp").data("celular").length);
     }
     ...
     if(predCel == 55){
      ...
      jQuery("#formApp").data("Enviarcc",true);


      var emailcontra = jQuery("#formApp").data("email");
      var spcontra = emailcontra.split('@');
      console.log(spcontra[0]); // john.doe
      /*Contraseña */
      jQuery("#formApp").data("Contrasena", jQuery("#frm_contra1").val());
      jQuery("#formApp").data("TelefonoCasa", jQuery("#frm_tel_casa").val());
      /*Contraseña */
