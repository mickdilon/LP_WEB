...
@Component({
  selector: 'frm-apaterno',
  templateUrl: './frm-apaterno.component.html',
  styleUrls: ['./frm-apaterno.component.css'],
  providers: [ NavegadorService ]
})

export class frmApaternoComponent
{ 
    ...
    ngOnInit()
    {
      this.inputComponent = this.fase + '.frm_apaterno';
