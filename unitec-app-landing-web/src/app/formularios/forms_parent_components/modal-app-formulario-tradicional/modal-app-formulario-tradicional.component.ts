...
export class ModalAppFormularioTradicionalComponent implements OnInit {
  titulo_modal_formulario: any = "Solicita Información V1";
  ...
  constructor(
    ...
    jQuery(document).ready(function() {
      ...
      //Titulo del modal
      var titulo_modal_formulario: any = "Solicita Información V2";
      ...
      var recurso_predeterminado = "aaaaaa";
      ...
      if (valores_cookie == "true") {
        ...
        if (
          ...
          url_multimedia_formulario = "aaaaaaaaa";
