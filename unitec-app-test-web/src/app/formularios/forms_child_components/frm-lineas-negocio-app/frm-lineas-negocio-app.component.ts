...
export class frmLineasNegocioAppComponent {
  ...
  constructor(
    ...
    //console.log(JSON.parse(localStorage.getItem("jsonCarrerasCRM")));
    ...
    var that = this;
    setTimeout(function(){  
      for(var lin=0;lin<that.lineasNegocio.length;lin++){

        if(that.lineasNegocio[lin].crmit_name == "PREPARATORIA") {
          that.lineasNegocio[lin]["class"] = "cuadro-prepa PREPA";
        }else if(that.lineasNegocio[lin].crmit_name == "LICENCIATURA") {
          that.lineasNegocio[lin]["class"] = "cuadro-lic UG";
        }else if(that.lineasNegocio[lin].crmit_name == "INGENIERIA") {
          that.lineasNegocio[lin]["class"] = "cuadro-ing ING";
        }else if(that.lineasNegocio[lin].crmit_name == "SALUD") {
          that.lineasNegocio[lin]["class"] == "cuadro-salud CS";
        }else if(that.lineasNegocio[lin].crmit_name == "POSGRADO") {
          that.lineasNegocio[lin]["class"] = "cuadro-pos POS";
        }else {
          that.lineasNegocio[lin]["class"] = "cuadro-lic UG";
        }
  ...
  clickProducto(idDynamics)
  {
    ...
    //console.log(JSON.parse(localStorage.getItem("jsonCarreras")));
